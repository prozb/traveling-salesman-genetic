...
//    public static final int THREADS_NUM  = 1;
    public static final int THREADS_NUM  = 8;      //how much threads will be execute calculation (best way is when
